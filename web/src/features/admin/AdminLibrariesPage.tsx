  ...
  return (
    <article className="lux-admin-library-card" ref={menuRef}>
      <div className="lux-admin-library-cover-wrap">
        <button className="lux-admin-library-cover-trigger" type="button" aria-label={`编辑 ${library.name} 媒体库`} onClick={openEdit}>
          {library.coverImageUrl ? <img className="lux-admin-library-cover" src={library.coverImageUrl} alt="" /> : <span className="lux-admin-library-cover-placeholder"><Image size={30} aria-hidden="true" /></span>}
        </button>
