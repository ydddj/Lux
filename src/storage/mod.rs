...
pub(crate) use repository::{
    ...
    PersonMatchCandidateRestore, ReconciliationBatchCommit, ReconciliationBatchCommitResult,
    ...
    StoredItemImageCandidate, StoredItemImagePathConflict, StoredItemScanPath,
